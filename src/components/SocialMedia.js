...
const SocialMedia = () => (
    <div className='main-container socialmedia' id='contact'>
        ...
        <div className='socialmedia-container'>
            ...
            <a href="http://www.instagram.com/rea.webdev" aria-label="Link to Instagram Profile"><img className="socialmedia__image socialmedia__image--instagram" src="/img/instagram.png" alt="Link to Instagram Profile" aria-hidden="true"/></a>
