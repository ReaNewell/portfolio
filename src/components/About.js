...
const About = () => (
    <div className="about" id="about">
        <div className='main-container'>
            ...
            <div>
                <img className="about-image" src="/img/reanewell.jpeg" alt="Picture of Me"/>
                <p className="about-body">
                    ...
                    I have worked on building my skills in Front-End Development for the past year. 
                    I am familiar with HTML, CSS, and JavaScript. 
                    My primary framework is ReactJS, 
                    and I enjoy using other materials like Webpack and Redux.
                    <br/>
                    <br/>
